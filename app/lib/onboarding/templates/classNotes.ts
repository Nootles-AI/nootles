...
const STEPS = `<nt-diagram h="376">
  <nt-rect id="p1" x="160" y="24" w="280" h="52" style="${BOX}">Form A − λI</nt-rect>
  <nt-rect id="p2" x="160" y="116" w="280" h="52" style="${BOX}">Set det(A − λI) = 0</nt-rect>
  <nt-rect id="p3" x="160" y="208" w="280" h="52" style="${BOX}">Solve for λ</nt-rect>
  <nt-rect id="p4" x="160" y="300" w="280" h="52" style="${ACCENT}">Back-substitute for v</nt-rect>
