...
const FLOW = `<nt-diagram h="536">
  <nt-rect id="s1" x="200" y="24" w="200" h="52" style="${BOX}">Cart</nt-rect>
  <nt-rect id="s2" x="180" y="116" w="240" h="52" style="${BOX}">Checkout — email only</nt-rect>
  <nt-polygon id="s3" x="180" y="208" w="240" h="112" sides="4" style="${PLAIN}">Account exists?</nt-polygon>
  <nt-rect id="s4" x="40" y="368" w="200" h="52" style="${ACCENT}">Pay as guest</nt-rect>
  <nt-rect id="s5" x="360" y="368" w="200" h="52" style="${BOX}">Offer sign in</nt-rect>
  <nt-rect id="s6" x="200" y="460" w="200" h="52" style="${BOX}">Confirmation</nt-rect>
