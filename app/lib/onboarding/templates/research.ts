...
const DESIGN = `<nt-diagram h="229">
  <nt-group id="g1" x="40" y="24" w="520" h="181" style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 1px; padding: 1px; background: ${GRID_LINE}">
    ${cell("h1", "Method", HEAD)}
    ${cell("h2", "Who", HEAD)}
